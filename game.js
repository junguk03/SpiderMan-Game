...
function createLevels() {
    ...
    levels.push({
        ...
        walls: [
            { x: 400, y: 180, w: 20, h: 170 },     // 단일 벽만
            { x: 900, y: 150, w: 20, h: 220 }      // 단일 벽만
        ],
        anchors: [
            { x: 200, y: 100 },
            { x: 550, y: 50 },
        ...
        stars: [
            { x: 500, y: 100 },    // 벽 옆 열린 공간으로 이동
            { x: 1000, y: 80 },    // 벽 옆 열린 공간으로 이동
            { x: 1150, y: 50 },
            { x: 1700, y: 30 },
            { x: 2050, y: 100 }
        ],
